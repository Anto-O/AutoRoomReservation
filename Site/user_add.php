...
<body>
<div class="login">
<h1 class="text-center titre_login mt-11">Créer un utilisateur</h1>
<div class="overflow-hidden flex items-center justify-center">
  <div class="bg-white lg:w-5/12 md:6/12 w-10/12 shadow-3xl">
    <form class="p-12" action="/user_add.php" method="POST">
    <div class="flex items-center text-lg mb-6">
      ...
      <button type="submit" class="font-medium p-2 md:p-4 button_register uppercase w-full">Créer un utilisateur</button>
      </div>
    </form>
  </div>
 </div>
